...
startPostgres(){
  ...
  echo '======================================='
  gnome-terminal --geometry=140x35 --window --zoom=0.8 --title="Postgres" -- docker run --name=postgres --rm --network host -e POSTGRES_USER=$POSTGRES_USER -e POSTGRES_PASSWORD=$POSTGRES_PASSWORD -e POSTGRES_DB=$POSTGRES_DB postgres
}
